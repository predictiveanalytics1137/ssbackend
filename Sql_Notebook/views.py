...
# #                         columns = [{"name": col['Name'], "type": col['Type']} for col in column_info]
...
# #                         data_dict = {}
# #                         for idx, datum in enumerate(row['Data']):
# #                             # Assign None if VarCharValue is not present
# #                             data_dict[columns[idx]['name']] = datum.get('VarCharValue', None)
