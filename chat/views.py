...
# #         # 1) We'll define a small function to parse the user’s "time_horizon"
...
# #         # parse the user’s horizon for step 3
...
# #         # (like the user’s 1000 limit or something).
# #         # We'll do daily increments, then date_trunc them to the user’s time_granularity.
